...
document.querySelector("#seatlayoutbox")
// Handle click events for seats
seats.forEach(seat => {
 seat.addEventListener('click', () => {
    // Add validation logic here
    if (selectedSeats.length < 5) { // You can change this condition to set the maximum number of seats a user can book
      ...
      alert('You can book a maximum of 5 seats. Please deselect some seats before booking more.');
    }
 });
});

// Handle click events for the booking buttons
document.getElementById('book_ticket').addEventListener('click', () => {
 if (selectedSeats.length > 0) {
    // Update your database here with the selectedSeats information
...
document.getElementById('back_ticket').addEventListener('click', () => {
 selectedSeats.forEach(seat => {
    document.querySelector(`.seat:contains(${seat})`).classList.remove('selected');
 });
...
function updateTicket() {
 ...
 if (selectedSeats.length > 0) {
    ...
    // ticket.innerHTML = '<h2>Please select at least one seat.</h2>';
 }
}
...
let pvr = [
    ...
    },
    {
        ...
        date: 31,
        img: 'img/Leo.jpg',
        video: 'video/LEO - Official Trailer _ Thalapathy Vijay _ Lokesh Kanagaraj _ Anirudh Ravichander.mp4',
        background: 'img/Leo_bgjpg.jpg',
    },
    {
        pvr: 'PVR Vegus',
        movie: 'CaptainMiller',
        ...
        price: [ 800, 800, 560, 560, 560, 560, 430, 430 ],
        date: 31,
        img: 'img/captain miller.jpg',
        video: 'video/CAPTAIN MILLER - Trailer _ Dhanush _ Shivarajkumar, Sundeep Kishan _ Arun Matheswaran.mp4',
        background: 'img/captain_bg.jpg',
    },
    {
        pvr: 'PVR Vegus',
        movie: 'Salaar-Part-1',
    ...
    },
    {
        ...
        price: [ 800, 800, 560, 560, 560, 560, 430, 430 ],
        date: 31,
        img: 'img/oppenheimer.jpg',
        video: 'video/CAPTAIN MILLER - Trailer _ Dhanush _ Shivarajkumar, Sundeep Kishan _ Arun Matheswaran.mp4',
        background: 'img/oppenheimerbg.jpg',
    },
    {
        pvr: 'PVR Vegus',
        movie: 'Kgf-2',
    ...
    },
    {
        ...
        img: 'img/thangalaan.jpg',
        video: 'video/CAPTAIN MILLER - Trailer _ Dhanush _ Shivarajkumar, Sundeep Kishan _ Arun Matheswaran.mp4',
        background: 'img/thangalaanbg.jpg',
    },
    {
        pvr: 'PVR Vegus',
        movie: 'Ayalaan',
